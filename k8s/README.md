# Kubernetes Manifests - FIAP Catalog API

Manifestos Kubernetes para deploy da Catalog API no cluster.
...
- ✅ Namespace: `fiap-cloud-games` - FIAP Catalog API
...
containers:
  - name: catalog-api
    image: seu-registry.azurecr.io/fiap-catalog-api:v1.0.0
